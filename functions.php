...
function calgarybrightminds_files() {
    wp_enqueue_style('calgarybrightminds_main_style', get_theme_file_uri( '/css/styles.css' ));
    wp_enqueue_style('calgarybrightminds-fonts','https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700;800;900&display=swap',array(),null);

    wp_enqueue_style('swiper','https://cdn.jsdelivr.net/npm/swiper@12/swiper-bundle.min.css', array(), '12');

    wp_enqueue_style('odometer','https://cdnjs.cloudflare.com/ajax/libs/odometer.js/0.4.8/themes/odometer-theme-default.min.css', array(),'0.4.8');

    wp_enqueue_style(
        'calgarybrightminds-main', get_theme_file_uri('/css/styles.css'), 
